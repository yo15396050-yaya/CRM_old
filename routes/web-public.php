...
//Route::get('/test-tickets', [FormController::class, 'testTickets']);
Route::get('/ticket/verify/{code}', [FormController::class , 'verify'])->name('ticket.verify');
Route::get('/form', [FormController::class , 'index'])->name('form.index');
Route::post('/form/store', [FormController::class , 'store'])->name('form.store');
Route::get('/success/{ticket_number}', [FormController::class , 'success'])->name('form.success');
Route::get('/download/{ticket_number}', [FormController::class , 'download'])->name('form.download');
Route::get('/download-all/{registration}', [FormController::class , 'downloadAll'])->name('form.downloadAll');
Route::get('/payment/{registration}', [FormController::class , 'payment'])->name('form.payment');
Route::post('/form/confirmpayment', [FormController::class , 'confirmPayment'])->name('form.confirmpayment');
Route::get('/send-whatsapp/{userId}', [NotificationController::class , 'sendWhatsAppNotification'])->name('send-whatsapp.sendWhatsAppNotification');

Route::get('/form/contract', [FormController::class , 'formcontract'])->name('form.contract');
Route::post('/form/contract/store', [FormController::class , 'storecontract'])->name('form.contract.store');
Route::get('/form/contract/show/{id}', [FormController::class , 'contractview'])->name('form.contract.show');
...
Route::get('/task-file-download/{id}', [PublicUrlController::class , 'taskFileDownload'])->name('front.task_file_download');
Route::get('/chat-file-download/{id}', [PublicUrlController::class , 'chatFileDownload'])->name('front.chat_file_download');
Route::get('/project-file-download/{id}', [PublicUrlController::class , 'projectFileDownload'])->name('front.project_file_download');
