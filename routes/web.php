...
use App\Http\Controllers\EtatFinanciersController;
...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::post('clients/toggle-radiation/{id}', [ClientController::class , 'toggleRadiation'])->name('clients.toggleRadiation');
    Route::post('clients/toggle-radiation-validate/{id}', [ClientController::class , 'toggleRadiationValidate'])->name('clients.toggleRadiationValidate');
    Route::post('clients/toggle-radiation-cancel/{id}', [ClientController::class , 'toggleRadiationCancel'])->name('clients.toggleRadiationCancel');
    Route::get('clients/apply-toggle-radiation/{id}', [ClientController::class , 'applyToggleRadiation'])->name('clients.apply_toggleRadiation');
    Route::get('clients/services', [AuthController::class , 'services'])->name('clients.services');

    Route::post('clients/toggle-inactif/{id}', [ClientController::class , 'toggleInactif'])->name('clients.toggleInactif');
    Route::post('clients/toggle-inactif-validate/{id}', [ClientController::class , 'toggleInactifValidate'])->name('clients.toggleInactifValidate');
    Route::post('clients/toggle-inactif-cancel/{id}', [ClientController::class , 'toggleInactifCancel'])->name('clients.toggleInactifCancel');
    Route::get('clients/apply-toggle-inactif/{id}', [ClientController::class , 'applyToggleInactif'])->name('clients.apply_toggleInactif');
    Route::get('clients/ajax/fiscale', [ClientController::class , 'clientFiscale'])->name('clients.fiscale');
    Route::get('clients/ajax/createfiscale', [ClientController::class , 'createFiscale'])->name('clients.createfiscale');
    Route::post('clients/ajax/storefiscale', [ClientController::class , 'storeFiscale'])->name('clients.storeFiscale');
    ...
    Route::get('clients/radiation', [ClientController::class , 'radiationClient'])->name('clients.radiation');
    ...
    Route::post('radiation/request', [RadiationRequestController::class , 'requestRadiation'])->name('radiation.request');
    Route::post('radiation/validate/{id}', [RadiationRequestController::class , 'validateRadiationRequest'])->name('radiation.validate');
    Route::get('radiation/requests', [RadiationRequestController::class , 'listRequests'])->name('radiation.requests');
    ...
    Route::post('projects/change-status-etat', [ProjectController::class , 'changeStatusEtat'])->name('projects.change_status_etat');

    Route::group(
    ['prefix' => 'projects'],
        function () {

            Route::get('select-channels', [ProjectController::class , 'selectChannels'])->name('projects.select_channels');
            Route::get('comptaGestion', [ProjectController::class , 'comptaGestion'])->name('projects.comptaGestion');
            Route::get('formation', [ProjectController::class , 'formation'])->name('projects.formation');
            Route::get('fiscalite', [ProjectController::class , 'fiscalite'])->name('projects.fiscalite');
            Route::get('autresServices', [ProjectController::class , 'autresServices'])->name('projects.autresServices');

            Route::get('etatfinanciers', [ProjectController::class , 'etatFinanciers'])->name('projects.etatFinanciers');
            Route::get('etatfinanciers/show/{id}', [ProjectController::class , 'etatFinanciersShow'])->name('projects.etatFinanciers.show');
            Route::get('etatfinanciers/{id}', [ProjectController::class , 'etatFinanciersApply'])->name('projects.etatFinanciers.apply');
            Route::post('updateStatusEtat/{id}', [ProjectController::class , 'updateStatusEtat'])->name('projects.update_status_etat');
            ...
            Route::post('send-notifications/{id}', [ProjectController::class , 'sendNotifications'])->name('projects.send_notifications');
        ...
        /* TASKS */
        Route::get('tasks/select-channels', [TaskController::class , 'selectChannels'])->name('tasks.select_channels');
        ...
        Route::post('tasks/send-notifications/{id}', [TaskController::class , 'sendNotifications'])->name('tasks.send_notifications');
        ...
        Route::get('leaves/export-all-leave/{startDate}/{endDate}', [LeaveController::class , 'exportAllLeaves'])->name('leaves.export_all_leave');
        ...
        Route::get('invoices/updateEnteteOn/{id}', [InvoiceController::class , 'updateEnteteOn'])->name('invoices.updateEnteteOn');
        Route::get('invoices/updateEnteteOff/{id}', [InvoiceController::class , 'updateEnteteOff'])->name('invoices.updateEnteteOff');
        ...
        Route::group(['prefix' => 'timelogs'], function () {
            ...
            Route::get('/timelogs/payments', [TimelogController::class , 'adminPayments'])->name('timelogs.payments');
            Route::post('/timelogs/payments/{registration}/validate', [FormController::class , 'validatePayment'])->name('timelogs.validatePayment');
            Route::post('/timelogs/payments/{registration}/reject', [FormController::class , 'rejectPayment'])->name('timelogs.rejectPayment');
        }
        );
        ...
        Route::get('contracts/showrenew/{id}', [ContractController::class , 'showrenew'])->name('contracts.showrenew');
        ...
        Route::post('contracts/updateRenew/{id}', [ContractController::class , 'updateRenew'])->name('contracts.updateRenew');
