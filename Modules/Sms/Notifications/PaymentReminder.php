...
class PaymentReminder extends Notification implements ShouldQueue
{
    ...
    public function toTwilio($notifiable)
    {
        ...
        $message = __($this->smsSetting->slug->translationString(), ['invoiceNumber' => $this->invoice->invoice_number, 'dueDate' => $this->invoice->due_date->format($this->company->date_format)]);
