...
class NewTaskSms extends Notification implements ShouldQueue
{
    ...
    public function toTwilio($notifiable)
    {
        ...
        $message = __($this->smsSetting->slug->translationString(), ['heading' => $this->task->heading, 'taskId' => $this->task->id, 'dueDate' => $this->task->due_date->format($this->task->company->date_format)]);
