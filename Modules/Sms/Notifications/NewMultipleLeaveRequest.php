...
class NewMultipleLeaveRequest extends Notification implements ShouldQueue
{
    ...
    {
        $this->toWhatsapp($notifiable, __($this->smsSetting->slug->translationString(), ['name' => $this->leave->user->name, 'reason' => $this->leave->reason, 'leaveType' => $this->leave->type->type_name]));
