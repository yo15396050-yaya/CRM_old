...
class NewTicketSms extends Notification implements ShouldQueue
{
    ...
    public function toTwilio($notifiable)
    {
        ...
        $message = __($this->smsSetting->slug->translationString(), ['ticketId' => $this->ticket->ticket_number, 'subject' => $this->ticket->subject, 'ticketRequesterName' => ($this->ticket->requester->name)]);
