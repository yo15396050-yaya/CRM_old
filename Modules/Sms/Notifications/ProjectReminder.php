...
class ProjectReminder extends Notification implements ShouldQueue
{
    ...
    public function toTwilio($notifiable)
    {
        ...
        $dueDate = Carbon::now($this->data['global_setting']->timezone)->addDays($this->data['project_setting']->remind_time)->toFormattedDateString();
        $message = __($this->smsSetting->slug->translationString(), ['dueDate' => $dueDate]);
