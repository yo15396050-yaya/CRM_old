...
class PublicUrlController extends Controller
{
    ...
    public function contractView(Request $request, $hash)
    {
        ...
        $pageIcon = 'fa fa-file';
        $contract = Contract::with(['signature', 'client', 'client.clientDetails', 'files'])
    ...
    {
        $file = \App\Models\ProjectFile::whereRaw('md5(id) = ?', $id)->firstOrFail();
        return download_local_s3($file, \App\Models\ProjectFile::FILE_PATH . '/' . $file->project_id . '/' . $file->hashname);
    }
