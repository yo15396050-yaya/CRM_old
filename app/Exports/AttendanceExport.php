    ...
    public function collection()
    {
        ...
        foreach ($employees as $employee) {
            ...
            $attendances = $attendances->orderBy('attendances.clock_in_time', 'asc')
                ...
                ->select('attendances.clock_in_time as date', 'attendances.clock_in_time', 'attendances.clock_out_time', 'attendances.late', 'attendances.half_day', 'attendances.auto_clock_out', 'attendances.half_day_type')->get();
