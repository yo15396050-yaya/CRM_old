...
class SocialeDatatable extends BaseDataTable
{  
    ...
    public function dataTable($query)
    {
        ...
        $datatables->rawColumns(array_merge(['name', 'action', 'check'], $customFieldColumns));
    ...
    public function query(User $model)
    {
        ...
        $users = $model->withoutGlobalScope(ActiveScope::class)
            ...
            ->join('situations_sociale', 'users.id', '=', 'situations_sociale.client_id')
            ->select('users.id', 'users.name', 'situations_sociale.type_impot', 'client_details.company_name', 'client_details.numadh', 'situations_sociale.regime', 'situations_sociale.montant','situations_sociale.periode', 'situations_sociale.date_paiement', 'client_categories.category_name', 'users.email', 'users.mobile', 'users.image', 'users.created_at', 'users.status', 'client_details.added_by', 'client_details.category_id', 'users.admin_approval')
    ...
    protected function getColumns()
    {
        $data = [
            ...
            __('type_impot') => ['data' => 'type_impot', 'name' => 'type_impot', 'title' => __('Type Impot')],
