...
class ClientDetails extends BaseModel
{
    ...
    protected $fillable = ['company_name', 'company_name_com', 'user_id', 'numcga', 'numadh', 'formjurid', 'regime', 'acti_prin', 'section', 'parcelle', 'imp_centre', 'codeacti', 'montcapit', 'address', 'postal_code', 'state', 'city', 'office', 'cell', 'website', 'note', 'skype', 'facebook', 'twitter', 'linkedin', 'tax_name', 'gst_number', 'shipping_address', 'category_id', 'sub_category_id', 'company_logo', 'electronic_address', 'electronic_address_scheme'];

    protected $default = ['id', 'company_name', 'company_name_com', 'address', 'numcga', 'numadh', 'formjurid', 'regime', 'acti_prin', 'section', 'parcelle', 'imp_centre', 'codeacti', 'montcapit', 'website', 'note', 'skype', 'facebook', 'twitter', 'linkedin', 'tax_name', 'gst_number', 'name', 'email', 'company_logo', 'office', 'city', 'postal_code', 'state', 'numrccm', 'shipping_address'];
