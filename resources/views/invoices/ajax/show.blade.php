    ...
    <div class="card-body">
        ...
        <div class="invoice-table-wrapper">
            <table width="100%">
                <tr>
                    <td>
                        <div class="row">
                            <div class="col-md-2">
                                <form action="{{ route('invoices.updateEnteteOn', $invoice->id) }}" method="GET">
                                    @csrf
                                    <button type="submit" class="btn btn-primary me-4 mb-3" onclick="" id="showlogo">Avec entête</button> 
                                </form>
                            </div>
                            <div class="col-md-2">
                                <form action="{{ route('invoices.updateEnteteOff', $invoice->id) }}" method="GET">
                                    @csrf
                                    <button type="submit" class="btn btn-secondary mb-3" onclick="" id="hidelogo">Sans entête</button>
                                </form>
                            </div>
                        </div>
                    </td>
                ...
                <tr class="inv-logo-heading">
                    <td>
                        @if($invoice->ip_address == 1)
                            <img src="{{ invoice_setting()->logo_url }}" alt="{{ company()->company_name }}" id="logo" style="display:block;"/>
                        @endif
                    </td>
            ...
            <table width="100%">
                <tr class="inv-unpaid">
                    <td class="f-14 text-dark">
                        <p class="mb-0 text-left" style="margin-left:50px;">
                            @if ($invoice->client || $invoice->clientDetails)
                                ...
                                @if ($invoice->clientDetails && $invoice->clientDetails->company_name_com && invoice_setting()->show_client_company_name_com == 'yes')
                                    Nom commercial : <b>{{ $invoice->clientDetails->company_name_com }}</b><br>
                                @endif
                    ...
                    <td align="right" class="mt-2 mt-lg-0 mt-md-0">
                        ...
                        @if ($invoice->status == 'paid')
                            <span class="paid text-success border-success rounded f-15 ">
                        ...
                        <table class="inv-detail f-14 table-responsive-sm" width="100%">
                            <tr class="i-d-heading bg-light-grey text-dark-grey font-weight-bold">
                                ...
                                <td class="border-left-0" align="right"
                                    ...
                                    @lang('modules.invoices.amount') TTC
                                </td>
                            </tr>
                                ...
                                <td class="p-0 border-right-0" align="right">
                                    <table width="100%">
                                        <tr class="text-dark-grey" align="right">
                                            <td class="w-30 border-top-0 border-left-0">
            ...
            @if($invoice->invoicePaymentDetail)
                <table class="table table-bordered mt-4" style="width:50%">
                    <thead class="thead-light">
                        <tr>
                            <th colspan="2">@lang('modules.invoices.paymentDetails')</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
            ...
            <table class="inv-note">
                ...
                <tr>
                    <td style="vertical-align: text-top">
                        ...
                        <i>Nous vous remercions de votre confiance !</i>
                        <br>
                        <br>
                        <i><b>DC-KNOWING THE BESPOKE PARTNER.</b></i> 	
                    </td>
                    <td style="text-align: right;">
                        ...
                        <img src="{{ $invoiceSetting->authorised_signatory_signature_url }}"
                                             alt="{{ $company->company_name }}" width="30%" id="signature"/>
                        @endif
                    </td>
                </tr>
