...
<div id="task-detail-section">
            ...
            <div class="card bg-white border-0 b-shadow-4">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                                    ...
                                    @if (in_array('admin', user_roles()))
                                        <hr class="my-1">
                                        <a class="dropdown-item send-task-notifications" href="javascript:;" data-task-id="{{ $task->id }}">
                                            <i class="fa fa-paper-plane mr-2"></i> Informer les bénéficiaires
                                        </a>
                                    @endif
                                </div>
                            </div>
                ...
                <div class="card-body">
                    ...
                    @if ($task->responsible_id)
                        <div class="col-12 px-0 pb-3 d-block d-lg-flex d-md-flex">
                            <p class="mb-0 text-lightest f-14 w-30 d-inline-block ">
                                @lang('app.responsible')</p>
                            <x-employee :user="$task->responsible"/>
                        </div>
                    @endif
                ...
                <div class="bg-additional-grey rounded my-3">
                    ...
                    <div class="s-b-inner s-b-notifications bg-white b-shadow-4 rounded">
                        ...
                        <x-tab-section class="task-tabs">
                            ...
                            {{-- <x-tab-item class="ajax-tab" :active="(request('view') === 'communication')"
                                        :link="route('tasks.show', $task->id).'?view=communication'">
                                @lang('app.clientCommunication')
                            </x-tab-item> --}}
                        </x-tab-section>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').on('click', '.send-task-notifications', function() {
                var id = $(this).data('task-id');
                var url = "{{ route('tasks.send_notifications', ':id') }}";
                url = url.replace(':id', id);
                ...
                Swal.fire({
                    title: "@lang('messages.sweetAlertTitle')",
                    text: "Voulez-vous envoyer les notifications par mail et WhatsApp aux intervenants de cette tâche ?",
                    icon: 'info',
                    showCancelButton: true,
                    focusConfirm: false,
