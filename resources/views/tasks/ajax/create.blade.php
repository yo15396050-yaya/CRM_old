                                            ...
                                            @php
                                                if ($item->slug == 'completed' || $item->slug == 'incomplete') {
                                                    if ($item->slug == 'completed') {
                                                        $icon = "<i class='fa fa-circle mr-2 text-dark-green'></i>".$item->column_name;;
                                                    }
                                                    elseif($item->slug == 'incomplete'){
                                                        $icon = "<i class='fa fa-circle mr-2 text-red'></i>".$item->column_name;;
                                                    }
                                                }
                                                else {
                                                    if ($item->slug == 'to_do') {
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#save-more-task-form').click(function () {
            // Si on a déjà les canaux, on procède à la sauvegarde
            if ($('input[name="chosen_channels[]"]').length > 0) {
            ...
            window.notificationTriggerButton = "#save-more-task-form";
