        ...
        <x-form id="save-contract-data-form">
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                        ...
                        <!-- CONTRACT NUMBER END -->
                        <div class="col-md-6 col-lg-3" style="margin-top: -16px; display: none;">   
                    ...
                    <div class="col-md-6 col-lg-3">
                        <x-forms.label class="mb-12" fieldId="amount"
                                       :fieldLabel="__('modules.contracts.contractValue')"
                                       :popover="__('modules.contracts.setZero')" fieldRequired="false"></x-forms.label>
                        <x-forms.input-group>
                            <input type="number" id="amountct" min="0" name="amount" value="{{ $contractTemplate->amount ?? '0' }}"
                    ...
                    <div class="col-md-6 col-lg-5 due-date-box"
