    ...
    <div class="card-body">
        <div class="invoice-table-wrapper" id="invoice-wrapper">
            ...
            @elseif($ct == 'Nouvelle adhésion')
                <form action="{{ route('contracts.updateRenew', $contract->id) }}" method="POST">
                    @csrf
                    <button class="btn-secondary" type="submit">@lang('Renouvelé')</button>
                </form>
                <br><br> 
            ...
            @endif
            <div class="row" id="div_renew" style="display:none;">
                <div class="col-md-2"></div>
                <div class="col-md-7">
                    <div class="card-body-paper">
                        {!! $watermark !!} <!-- Injection du filigrane -->
                        ...
                        <p style="text-align:center;"><span style="font-size:14pt;">&#160;</span></p>
                        <p style="text-align:center;"><span style="font-size:14pt;">&#160;</span></p>
                        <p style="text-align:center;"><em><span style="font-size:14pt;color:#999999;"><strong>{{$contract->client->clientDetails->company_name}}</strong></span></em></p><p></p>
                        <p></p>
                        <p></p>
                        <p></p>
                        <p></p>
        ...
        <div class="d-flex">
            <div class="inv-action mr-3 mr-lg-3 mr-md-3 dropup">
                ...
                <ul class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdownMenuButton" tabindex="0">
                    ...
                    @endif
                    <li>
                        <a class="dropdown-item f-14 text-dark" href="{{ route('contracts.download', [$contract->id]) }}">
