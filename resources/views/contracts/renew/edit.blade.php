...
<div class="modal-body">
    <x-form id="edit-renew-data-form" method="PUT">
        <input type="hidden" name="contract_type_id" value="4">
        <input type="hidden" name="subject" value="Renouvellement d'attestation d'adhésion">
        <input type="hidden" name="contract_name" value="Renouvellement d'attestation d'adhésion">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <x-forms.input-group>
                    <x-slot name="append">
                        <span class="input-group-text height-35 border bg-white">
    ...
    $(document).ready(function() {
        ...
        $('#save-edit-renew').click(function() {
            ...
            $.easyAjax({
                ...
                type: "POST", // Utilise POST avec _method PUT via x-form
                disableButton: true,
                blockUI: true,
                ...
                success: function(response) {
                    if (response.status == "success") {
                        // Si vous êtes sur la vue de détail, on rafraîchit la zone des renouvellements
                        if ($('#comment-list').length > 0) {
                            $('#comment-list').html(response.view);
                        }
                        $(MODAL_LG).modal('hide');
                        
                        // Optionnel : recharger la page pour voir la nouvelle date sur le PDF/Aperçu
