...
<body>
    ...
    <div class="main-card">
        <div class="card-content">
            <div class="objet">{{ $taskHeading }}</div>
            
            <div class="greeting">Bonjour {{ $recipientName }},</div>
            
            <div style="color: #4a5568; font-size: 15px; margin-bottom: 25px;">
                Une mise à jour vient d'être effectuée concernant votre tâche.
            </div>

            <div class="note-title">Détails de la mise à jour :</div>
            <div class="note-box" style="line-height: 2;">
                ...
                <span style="color: #718096;">•</span> <strong>Nouveau statut :</strong> {{ $taskStatus }}<br>
            ...
            <div class="footer-text">
                Nous continuons de travailler sur votre dossier et vous tiendrons informé de toute évolution majeure.
                <br><br>
