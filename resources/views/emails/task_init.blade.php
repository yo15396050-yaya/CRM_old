    ...
    <div class="main-card">
        <div class="card-content">
            ...
            <div style="color: #4a5568; font-size: 15px; margin-bottom: 25px;">
                Ceci est une confirmation concernant la création d'une nouvelle tâche.
            </div>
            ...
            <div class="footer-text">
                Vous recevrez des notifications au fur et à mesure de l'avancement de votre dossier.
                <br><br>
                L'équipe technique reste à votre entière disposition.
            </div>
