...
<body>
    <div class="header-top">
        ...
        <div class="meta-info">Briefing Opérationnel - {{ $date }}</div>
    </div>

    <div class="main-card">
        <div class="card-content">
            <div class="objet">Nouvelle Diligence assignée</div>
            
            <div class="greeting">Bonjour {{ $recipientName }},</div>
            
            <div style="color: #4a5568; font-size: 15px; margin-bottom: 25px;">
                Vous venez d'être assigné à une nouvelle diligence. Veuillez prendre connaissance des détails ci-dessous et commencer le traitement dès que possible.
            </div>

            <div class="note-title">Détails de l'assignation :</div>
            <div class="note-box" style="line-height: 2;">
                <span style="color: #dd6b20;">•</span> <strong>Diligence :</strong> {{ $projectName }}<br>
                <span style="color: #dd6b20;">•</span> <strong>Projet :</strong> {{ $projectName }}<br>
                <span style="color: #dd6b20;">•</span> <strong>Date de réception :</strong> {{ $date }}<br>
            </div>
            ...
            <div class="footer-text">
                Connectez-vous a DCK TASKFLOW pour accéder à l'interface de travail et mettre à jour le statut de ce dossier.
                <br><br>
            ...
            <div class="btn-container">
                <a href="{{ $url }}" class="btn">Ouvrir la Diligence</a>
            </div>
        </div>
    </div>
</body>
