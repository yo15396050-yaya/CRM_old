    ...
    <div class="px-4 py-0 py-lg-4  border-top-0 admin-dashboard">
        <div class="row">
            <div class="col-xl-12 col-lg-6 col-md-6 mb-4">
                <div class="bg-white p-2 rounded b-shadow-4 d-flex mb-4 mb-md-0 mb-lg-0" style="justify-content:center;">
                    <h6><strong>Portail du Centre de Gestion agréé (CGA)</strong></h6>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-4 col-lg-2 col-md-6 mb-4">
                <div class="bg-white p-3 rounded b-shadow-4 d-flex justify-content-between align-items-center mb-4 mb-md-0 mb-lg-0">
                    <div class="d-block ">
                        <h5 class="f-15 f-w-500 mb-20 text-darkest-grey">Adhérent</h5>
                        <div class="d-flex">
            ...
            <div class="col-xl-4 col-lg-2 col-md-6 mb-4">
                <div class="bg-white p-3 rounded b-shadow-4 d-flex justify-content-between align-items-center mb-4 mb-md-0 mb-lg-0">
                    <div class="d-block ">
                        <h5 class="f-15 f-w-500 mb-20 text-darkest-grey">A la date du: 
                            @php    
                                echo date('Y-m-d');       
                            @endphp 
                        </h5>
                        <div class="d-flex">
                            <a href="{{ route('invoices.index') . '?status=pending' }}">
                                 <p class="font-weight-bold text-darkest-grey">Montant dû : {{ $totalPaidInvoice }}</p>
                            </a>
                        </div>
                    </div>      
                    <div class="d-block">  
