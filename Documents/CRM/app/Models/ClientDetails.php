...
class ClientDetails extends BaseModel
{
    ...
    protected $default = ['id', 'company_name','company_name_com', 'address', 'numcga', 'numadh', 'formjurid', 'regime', 'acti_prin', 'section', 'parcelle', 'imp_centre', 'codeacti', 'montcapit', 'website', 'note', 'skype', 'facebook', 'twitter', 'linkedin', 'tax_name', 'gst_number', 'name', 'email', 'company_logo'];
