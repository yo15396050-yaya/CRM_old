...
class ExpensesDataTable extends BaseDataTable
{
    ...
    protected function getColumns()
    {
        $data = [
            ...
            __('modules.expenses.purchaseFrom') => ['data' => 'account_name', 'name' => 'purchase_from', 'title' => __('Caisse')],
