...
class PaymentsDataTable extends BaseDataTable
{
    ...
    public function query()
    {
        ...
        $model = Payment::with([
            ...
            ->select('payments.id', 'payments.company_id', 'payments.project_id', 'payments.currency_id', 'payments.invoice_id', 'payments.amount', 'payments.status', 'payments.paid_on', 'payments.remarks', 'payments.bill', 'payments.added_by', 'payments.order_id', 'bank_accounts.account_name', 'payments.gateway', 'payments.transaction_id');
    ...
    protected function getColumns()
    {
        return [
            ...
            __('modules.payments.paymentGateway') => ['data' => 'account_name', 'name' => 'gateway', 'title' => __('modules.payments.paymentGateway')],
