...
class NewLeaveRequestSms extends Notification implements ShouldQueue
{
    ...
    {
        $this->toWhatsapp($notifiable, __($this->smsSetting->slug->translationString(), ['leaveDate' => $this->leave->leave_date->format($this->company->date_format), 'reason' => $this->leave->reason]));
