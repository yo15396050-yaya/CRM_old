...
class NewTaskSms extends Notification implements ShouldQueue
{
    ...
    {
        $this->toWhatsapp($notifiable, __($this->smsSetting->slug->translationString(), ['heading' => $this->task->heading, 'taskId' => $this->task->id, 'dueDate' => $this->task->due_date->format($this->task->company->date_format)]));
