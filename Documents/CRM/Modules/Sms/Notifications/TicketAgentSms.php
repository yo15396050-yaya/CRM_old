...
class TicketAgentSms extends Notification implements ShouldQueue
{
    ...
    {
        $this->toWhatsapp($notifiable, __($this->smsSetting->slug->translationString(), ['ticketId' => $this->ticket->id, 'subject' => $this->ticket->subject]));
    ...
    public function toMsg91($notifiable)
    {
        ...
        if ($this->smsSetting->msg91_flow_id && sms_setting()->msg91_status) {
            return (new \Craftsys\Notifications\Messages\Msg91SMS)
                ...
                ->variable('ticket_subject', ucfirst($subject));
        }
    }
