...
class NewExpenseMemberSms extends Notification implements ShouldQueue
{
    ...
    {
        $this->toWhatsapp($notifiable, __($this->smsSetting->slug->translationString(), ['itemName' => $this->expense->item_name, 'price' => currency_format($this->expense->price, $this->expense->currency_id)]));
        if (sms_setting()->status) {
