...
class TaskNote extends Notification implements ShouldQueue
{
    ...
    {
        $this->toWhatsapp($notifiable, __($this->smsSetting->slug->translationString(), ['heading' => $this->task->heading, 'taskId' => $this->task->id, 'project' => $this->task->project ? $this->task->project->project_name : '-']));
